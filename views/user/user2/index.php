...
<div class="container mt-5">
    <div style="margin-top: 100px;">
        ...
        if ($_GET['success'] === "pengajuan_true") {
            echo '<div class="alert alert-success alert-dismissible fade show mb-4" role="alert">
                                ...
                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"
                                    onclick="window.location.href=\'anggota' . $id_anggota . '\'"></button>
                              </div>';
        } elseif ($_GET['success'] === "pengajuan_false") {
            echo '<div class="alert alert-danger alert-dismissible fade show mb-4" role="alert">
        <strong>Berhasil Diedit</strong> 
                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"
                                    onclick="window.location.href=\'anggota' . $id_anggota . '\'"></button>
                              </div>';
        } elseif ($_GET['success'] === "transaksi_true") {
            echo '<div class="alert alert-success alert-dismissible fade show mb-4" role="alert">
                                <strong>Transaksi Berhasil</strong> 
                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"
                                    onclick="window.location.href=\'anggota' . $id_anggota . '\'"></button>
                              </div>';
        } elseif ($_GET['success'] === "transaksi_false") {
            echo '<div class="alert alert-danger alert-dismissible fade show mb-4" role="alert">
                                <strong>transaksi Berhasil</strong> 
                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"
                                    onclick="window.location.href=\'anggota' . $id_anggota . '\'"></button>
