...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <!-- Sidebar -->
            <nav class="col-md-3 col-lg-2 d-md-block sidebar" style="margin-top: 3%; padding-bottom: 420px;  background-color: #ececec;">
                <div class="sidebar-sticky">
                    <ul class="nav flex-column" style="margin-top: 30px;">
                        <li class="nav-item" style="margin-top: 10px; display: flex; align-items: center;">
                            <a class="nav-link text-dark" href="anggota">
                        ...
                        <li class="nav-item" style="margin-top: 10px; display: flex; align-items: center;">
                            <a class="nav-link text-dark" href="petugas">
                        ...
                        <li class="nav-item" style="margin-top: 10px; display: flex; align-items: center;">
                            <a class="nav-link text-dark" href="validasi">
                        ...
                        <li class="nav-item" style="margin-top: 10px; display: flex; align-items: center;">
                            <a class="nav-link text-dark" href="penyetujuan">
            ...
            <nav class="navbar navbar-dark fixed-top" style="background-color: #86b049;">
                <a class="navbar-brand" href="#" style="margin-left: 1%">Koperasi Sidaurip</a>
                ...
                <div class="ml-auto mt-1 d-flex align-items-center">
                    ...
                    <span class="ml-2 font-weight-bold text-white" style="margin-right: 30px;">Admin</span>
                </div>
            </nav>
